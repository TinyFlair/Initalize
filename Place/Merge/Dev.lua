local MapGame = remodel.readPlaceFile("Place/Files/Dev/GatesMap.rbxlx")
local CodeGame = remodel.readPlaceFile("Place/Files/Dev/GatesProgram.rbxlx")
local SaveServices = {
	["ReplicatedStorage"] = {},
	["ServerScriptService"]  = {},
	["ServerStorage"] = {},
...
remodel.writePlaceFile("Place/Files/Dev/Merge.rbxlx", MapGame)