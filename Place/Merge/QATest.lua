local MapGame = remodel.readPlaceFile("Place/Files/QATest/GatesMap.rbxlx")
local CodeGame = remodel.readPlaceFile("Place/Files/QATest/GatesProgram.rbxlx")
local SaveServices = {
	["ReplicatedStorage"] = {},
	["ServerScriptService"]  = {},
	["ServerStorage"] = {},
...
remodel.writePlaceFile("Place/Files/QATest/Merge.rbxlx", MapGame)